...
type SelectTriggerSize = "xs" | "sm" | "lg";

const selectTriggerSizeClasses: Record<SelectTriggerSize, string> = {
  xs: "h-7 px-2 py-1 text-xs",
  sm: "h-8 px-2.5 py-1.5 text-xs",
  lg: "h-10 px-4 py-2 text-sm sm:h-11",
};

const selectItemSizeClasses: Record<SelectTriggerSize, string> = {
  xs: "py-1 pl-7 pr-2 text-xs",
  sm: "py-1.5 pl-8 pr-2 text-xs",
  lg: "py-2 pl-9 pr-3 text-sm",
};
...
>(({ className, children, size, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      size ? selectTriggerSizeClasses[size] : "h-9 px-3 py-2 text-sm sm:h-10",
      className
    )}
    {...props}
  >
...
>(({ className, children, size, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      size ? selectItemSizeClasses[size] : "py-1.5 pl-8 pr-2 text-sm",
      className
    )}
    {...props}
  >
